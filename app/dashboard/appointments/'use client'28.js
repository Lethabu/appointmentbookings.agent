  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Book an Appointment at</h1>
        <h2 className="text-2xl font-semibold text-indigo-600 mb-4">{salon?.name}</h2>
        <Link href={`/${salonIdentifier}/shop`} className="text-indigo-600 hover:text-indigo-800 hover:underline">
          Visit our Shop 🛍️
        </Link>
      </div>
